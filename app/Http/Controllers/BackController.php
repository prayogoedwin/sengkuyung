...
class BackController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Resolve grup status verifikasi (bucket dashboard).
        // Logika resolver dipakai bersama halaman verifikasi via App\Support\VerifikasiStatusGroups.
    ...
    private function applyDashboardFiltersToDataTertagihQuery($query, Request $request): void
    {
        ...
        $kecamatanFilter = ($isKecamatanScope && !empty($userKecamatanSamsat))
