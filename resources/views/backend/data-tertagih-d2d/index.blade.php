            ...
            <div class="layout-page">
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <a href="{{ route('data-tertagih-d2d.template', ['format' => 'xlsx', 'type' => 'format']) }}"
                                        class="btn btn-outline-success btn-sm">
                                        Download Format Excel (Tanpa Isi)
                                    </a>
                                    <a href="{{ route('data-tertagih-d2d.template', ['format' => 'csv', 'type' => 'format']) }}"
                                        class="btn btn-outline-secondary btn-sm">
                                        Download Format CSV (Tanpa Isi)
                                    </a>
                                    <a href="{{ route('data-tertagih-d2d.template', ['format' => 'xlsx', 'type' => 'contoh']) }}"
                                        class="btn btn-success btn-sm">
                                        Download Contoh Excel (10 Baris)
                                    </a>
                                    <a href="{{ route('data-tertagih-d2d.template', ['format' => 'csv', 'type' => 'contoh']) }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">List Data Tertagih D2D</h5>
                            </div>
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-3">
...
@push('js')
    <script>
        ...
        function toggleTertagihStatus(id, status) {
            $.ajax({
                url: "{{ route('data-tertagih-d2d.update-status', ':id') }}".replace(':id', id),
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    is_terdata: status
        ...
        function deleteTertagih(id) {
            Swal.fire({
                ...
                $.ajax({
                    url: "{{ route('data-tertagih-d2d.destroy', ':id') }}".replace(':id', id),
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
