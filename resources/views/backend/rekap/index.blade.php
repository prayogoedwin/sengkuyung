                            ...
                            <form method="GET" action="{{ route($rekapRouteIndex ?? 'rekap.index') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mt-4">
                                        ...
                                        <a href="{{ route($rekapRouteIndex ?? 'rekap.index') }}" class="btn btn-warning btn-sm"><i class="menu-icon tf-icons bx bx-refresh" style="padding-left:7px"></i></a>
...
<script>
    $(document).ready(function() {
        ...
        var selectedLokasiSamsat = '{{ \App\Models\SengSaamsat::resolveDropdownLokasiId(request('lokasi_samsat')) ?? request('lokasi_samsat') }}';
