            ...
            @if ($isSuperAdmin)
                <li class="menu-item {{ request()->routeIs('version.*') || request()->routeIs('jasa-raharja.*') || request()->routeIs('cache-management.*') || request()->routeIs('maintenance-status.*') || request()->routeIs('rekap-visual-filter-cache.*') ? 'active open' : '' }}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ request()->routeIs('rekap-visual-filter-cache.*') ? 'active' : '' }}">
                            <a href="{{ route('rekap-visual-filter-cache.index') }}" class="menu-link">
                                <div data-i18n="Analytics">Cache Rekap Visual Filter</div>
                            </a>
                        </li>
